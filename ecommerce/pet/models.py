...
class PetModel(models.Model):
	...
	racaGato = models.CharField('Raça do Gato', max_length=250, blank=True, null=True, choices=t.RACA_GATO, default=None)
	...
	type_pelo = models.CharField('Pelo', max_length=150, blank=True, null=True, choices=t.TYPE_PELO_CHOICES, default=None)
